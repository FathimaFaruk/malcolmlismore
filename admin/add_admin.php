...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($usernameErr) && empty($emailErr) && empty($passwordErr) && empty($firstNameErr) && empty($lastNameErr)) {
        ...
        $sql = "INSERT INTO users (Username, Email, Password, FirstName, LastName, UserType) VALUES ('$username', '$email', '$hashedPassword', '$firstName', '$lastName', 'Admin')";
...
<body>
    ...
    <header class="jumbotron jumbotron-fluid">
        <div class="container text-center">
            ...
            <p class="lead">Register a new admin account.</p>
        </div>
    </header>
