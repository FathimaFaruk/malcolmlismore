...
<body>
    ...
    <header class="jumbotron jumbotron-fluid">
        <div class="container text-center">
            ...
            <p class="lead">Register a new user account.</p>
        </div>
    </header>
            ...
            <div class="col-md-6">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                    <div class="form-group">
                        <label for="firstName">
                            <x style="color: #ffffff;">First Name</x>
                        </label>
                    ...
                    <div class="form-group">
                        <label for="lastName">
                            <x style="color: #ffffff;">Last Name</x>
                        </label>
                    ...
                    <div class="form-group">
                        <label for="username">
                            <x style="color: #ffffff;">Username</x>
                        </label>
                    ...
                    <div class="form-group">
                        <label for="password">
                            <x style="color: #ffffff;">Password</x>
                        </label>
